...
public class DataBaseInsertAsyncTask extends AsyncTask<Void, Void, Void> {
	...
	public DatabaseHandler insertProgramListtoDB( Context context ) {
		...
		databaseHandler.addProgram_Index(new Program_Index(index++, "Stack Definition").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Stack Push Operation").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Stack Pop Operation").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Swap By Value").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Swap By Reference").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Swap By XOR").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Swap - 2 Variables").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Reverse Number").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Quick Sort").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Odd Even - ? Operator").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Factorial").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "HCF and LCM"));
		databaseHandler.addProgram_Index(new Program_Index(index++, "Decimal to binary conversion").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "nCr, nPr, Factorial").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Palindrome number").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Addition using Pointers").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Linear Search - Multiple Occurences").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Binary Search").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Reverse Array - Pointers").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Merge 2 Sorted Arrays").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Bubble Sort").save());
		databaseHandler.addProgram_Index(new Program_Index(index++, "Insertion Sort").save());
