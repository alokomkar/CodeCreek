...
class TopicDetailsTask(private val mContext: Context, private val mTopic: String, private val mTopicDetailsListener: TopicDetailsListener) : AsyncTask<Void, Void, ArrayList<TopicDetails>>() {

    interface TopicDetailsListener {
        fun onSuccess(topicDetails: ArrayList<TopicDetails>)
    }

    private val topicDetailsForTopic: ArrayList<TopicDetails>
        get() {

            var topicIndex = 1
            val programLanguage = "java"

            val topicDetailsArrayList = ArrayList<TopicDetails>()
            var topicDetails = TopicDetails(programLanguage + "_" + topicIndex++, programLanguage, "Java Basics")
            var subTopic = 1
            var subTopics = ArrayList<SubTopics>()
            var subTopics1 = SubTopics(
                    topicDetails.topicId + "_" + subTopic++,
                    programLanguage,
                    "What is Java programming language?",
                    "Java is a general-purpose computer programming language that is concurrent, class-based, object-oriented, and specifically designed to have as few implementation dependencies as possible. It is intended to let application developers “write once, run anywhere” (WORA), meaning that compiled Java code can run on all platforms that support Java without the need for recompilation.")
            subTopics.add(subTopics1)

            subTopics1 = SubTopics(
                    topicDetails.topicId + "_" + subTopic++,
                    programLanguage,
                    "For example",
            ...
            topicDetails.subTopicsArrayList = subTopics
            topicDetailsArrayList.add(topicDetails)


            topicDetails = TopicDetails(programLanguage + "_" + topicIndex++, programLanguage, "Working with Class[class]")
            subTopic = 1
            subTopics = ArrayList<SubTopics>()
            subTopics1 = SubTopics(
                    topicDetails.topicId + "_" + subTopic++,
                    programLanguage,
    ...
    override fun doInBackground(vararg voids: Void): ArrayList<TopicDetails> {
        return topicDetailsForTopic
    }
    ...
    override fun onPostExecute(topicDetails: ArrayList<TopicDetails>) {
