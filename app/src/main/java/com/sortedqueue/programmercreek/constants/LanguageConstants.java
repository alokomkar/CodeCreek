...
public interface LanguageConstants {
    ...
    // "3":"Perl (perl 5.20.1)",
    // "54":"Perl 6 (perl6 2014.07)","29":"PHP (PHP 5.6.11-1)","19":"Pike (pike v7.8)","108":"Prolog (gnu prolog 1.4.5)","15":"Prolog (swi) (swi 7.2)","4":"Python (2.7.10)","99":"Python (Pypy) (PyPy 2.6.0)","116":"Python 3 (Python 3.4.3+)","117":"R (3.2.2)","17":"Ruby (ruby 2.1.5)","39":"Scala (2.11.7)","18":"Scheme (stalin 0.3)","33":"Scheme (guile) (guile 2.0.11)","46":"Sed (sed 4.2.2)","23":"Smalltalk (gst 3.2.4)",
    // "40":"SQL (sqlite3-3.8.7)","85":"Swift (swift 3.0.2)","38":"Tcl (tclsh 8.6)","50":"VB.NET (mono 4.0.2)","6":"Whitespace (wspace 0.3)"}
}
