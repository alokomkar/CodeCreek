...
public class NotesActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if( requestCode == SPEECH_REQUEST && resultCode == AppCompatActivity.RESULT_OK ) {
            ...
            CommonUtils.displayToast(NotesActivity.this, results.toString());
            return;
        }
    ...
    public void onToggleScreenShare(View view) {
        if (((ToggleButton) view).isChecked()) {
            CommonUtils.displayToast(NotesActivity.this, R.string.start_recording);
            initRecorder();
            shareScreen();
            //openVoiceIntent();
        } else {
            ...
            CommonUtils.displayToast(NotesActivity.this, R.string.stop_recording);
            stopScreenSharing();
        }
    }
    ...
    private void openVoiceIntent() {
        ...
        try {
            ...
            e.printStackTrace();
            AuxilaryUtils.displayAlert("No Voice App", "Your device doesn't support voice input - no app found", NotesActivity.this);
        }
