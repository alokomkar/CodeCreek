...
public class NoteShareActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private NotesShareRecyclerAdapter notesShareRecyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        creekPreferences = new CreekPreferences(NoteShareActivity.this);
    ...
    private void fetchAllTags() {
        ...
        new FirebaseDatabaseHandler(NoteShareActivity.this).getAllTags(new FirebaseDatabaseHandler.GetAllTagsListener() {
            @Override
    ...
    private void setupRecyclerView(TagModel tagModel) {
        languageRecyclerView.setLayoutManager(new LinearLayoutManager(NoteShareActivity.this, LinearLayoutManager.HORIZONTAL, false));
        ...
        if (sharedText != null) {
            new AsyncTask<Void, Void, ArrayList<NotesModel>>() {
                ...
                protected void onPreExecute() {
                    super.onPreExecute();
                    CommonUtils.displayProgressDialog(NoteShareActivity.this, "Loading");
                }
    ...
    private void setupRecyclerView(ArrayList<NotesModel> notesModelArrayList) {
        notesRecyclerView.setLayoutManager(new LinearLayoutManager(NoteShareActivity.this));
        notesShareRecyclerAdapter = new NotesShareRecyclerAdapter(notesModelArrayList);
        ...
        switch (view.getId()) {
            case R.id.saveButton:
                if( tagsRecyclerAdapter.getSelectedTag().equals("") ) {
                    CommonUtils.displayToast(NoteShareActivity.this, "Select language");
                    return;
                }
                break;
