...
public class FullScreenWizardActivity extends AppCompatActivity {
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);

		setContentView(R.layout.activity_full_screen_wizard);

		//final View controlsView = findViewById(R.id.fullscreen_content_controls);
		//final View contentView = findViewById(R.id.fullscreen_content);
		TextView titleTextView = (TextView) findViewById(R.id.fullscreen_content);
		titleTextView.setText("Learning Wizard");
		Button nextButton = (Button) findViewById(R.id.dummy_button);
